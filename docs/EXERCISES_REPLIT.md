# SignalFlow 101 Exercises — Replit Path
...
the Replit Secrets you configured earlier.
...
The take-home exercises do not include prebuilt Replit workflows. Use the Replit Shell or Console to run the `python ...` commands shown from the repo root.
...
Add your GitHub username to your workshop values by creating a new Replit Secret named `GITHUB_USERNAME` with your GitHub username as the value.
